...
class UserService {
    static register(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingUsername = yield database_1.prismaClient.user.count({
                where: {
            ...
            registerRequest.password = yield bcrypt_1.default.hash(registerRequest.password, 10); // Hash the password
